...
public class DataSeeder
{
    ...
    /// <summary>
    /// Creates a <see cref="Ticket"/> for a given <see cref="Flight"/> and <see cref="Passenger"/>,
    /// and updates the respective collections.
    /// </summary>
    /// <param name="flightIndex">Index of the flight in the <see cref="Flights"/> list.</param>
    /// <param name="passengerIndex">Index of the passenger in the <see cref="Passengers"/> list.</param>
